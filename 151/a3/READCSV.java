 ...
 * modified: Jan 3, 2022
 * modified: Jan 4, 2022
 * modified for lab Feb 3, 2022 by grace
 */
public class ReadCSV {
    ...
    public static void main(String[] args) 
    {
        ...
        try {
            ...
            ec = new ReadCSV("shuffzip.csv");
            List151Impl<Place> go = new List151Impl<>(50000);
        }
        ...
        try {
            ...
            //number of strings length greater than 0
            int numStrings = 0;
            ...
            //Prints number of lines,  number of strings of greater than 0 length in the array returned by the nextLine
            //method of ReadCSV, From among the strings of greater than 0 length, the number that start with double quotes
